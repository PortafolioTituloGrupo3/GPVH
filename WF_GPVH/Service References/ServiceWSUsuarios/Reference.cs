...
namespace WF_GPVH.ServiceWSUsuarios {
    ...
    public interface IWSUsuarios {
        ...
        WF_GPVH.ServiceWSUsuarios.Usuario AutenticarUsuario(string nombre, string clave);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWSUsuarios/AutenticarUsuario", ReplyAction="http://tempuri.org/IWSUsuarios/AutenticarUsuarioResponse")]
        System.Threading.Tasks.Task<WF_GPVH.ServiceWSUsuarios.Usuario> AutenticarUsuarioAsync(string nombre, string clave);
    }
    ...
    public partial class WSUsuariosClient : System.ServiceModel.ClientBase<WF_GPVH.ServiceWSUsuarios.IWSUsuarios>, WF_GPVH.ServiceWSUsuarios.IWSUsuarios {
        ...
        public WF_GPVH.ServiceWSUsuarios.Usuario AutenticarUsuario(string nombre, string clave) {
            return base.Channel.AutenticarUsuario(nombre, clave);
        }
        
        public System.Threading.Tasks.Task<WF_GPVH.ServiceWSUsuarios.Usuario> AutenticarUsuarioAsync(string nombre, string clave) {
